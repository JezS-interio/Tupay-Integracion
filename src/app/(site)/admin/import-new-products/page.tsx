...
export default function ImportNewProductsPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold mb-6">Import New Products</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Location: <code className="bg-gray-100 px-2 py-1 rounded">scripts/new_products/products_data.json</code>
              </p>
              <input
                type="file"
                accept=".json"
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Location: <code className="bg-gray-100 px-2 py-1 rounded">scripts/new_products/r2-urls.json</code>
              </p>
              <input
                type="file"
                accept=".json"
            ...
            <div className="border-2 border-solid border-blue-300 rounded-lg p-6 bg-blue-50">
              ...
              >
                {importing
                  ...
                  : `Import ${productsData.length} Products to Firestore`}
              </button>

              {imported > 0 && !importing && (
                <div className="mt-4 p-4 bg-green-100 border border-green-400 rounded">
                  <p className="text-green-800 font-semibold">
                    🎉 Successfully imported {imported}/{productsData.length} products!
                  </p>
                </div>
              )}
            ...
            <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-6">
              ...
              <ol className="list-decimal list-inside space-y-2 text-sm">
                <li>Run: <code className="bg-gray-100 px-2 py-1 rounded">python scripts/download-and-prepare-products.py</code></li>
                <li>Run: <code className="bg-gray-100 px-2 py-1 rounded">node scripts/upload-new-products-to-r2.js</code></li>
