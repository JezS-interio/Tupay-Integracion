...
export default function AddProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!images.thumbnail1 && !images.preview1) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-dark mb-2">Add New Product</h2>
        <p className="text-gray-600">Upload images and fill in product details</p>
      </div>
