                ...
                {!loading && (
                  user ? (
                    <div className="flex items-center gap-2.5 relative group">
                      ...
                      {/* Dropdown menu */}
                      <div className="absolute top-full right-0 mt-2 w-48 bg-white shadow-lg rounded-lg border border-gray-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <Link
                          href="/my-account"
                          className="block px-4 py-3 text-sm text-dark hover:bg-gray-1 border-b border-gray-3"
                        >
                          Mi Cuenta
                        </Link>
                        <button
                          onClick={handleSignOut}
                          className="w-full text-left px-4 py-3 text-sm text-dark hover:bg-gray-1"
                        >
                          Cerrar Sesión
                        </button>
                      </div>
