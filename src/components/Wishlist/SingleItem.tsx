...
import { removeItemFromWishlistAsync } from "@/redux/features/wishlist-slice";
...
const SingleItem = ({ item }) => {
  ...
  const handleRemoveFromWishlist = () => {
    dispatch(removeItemFromWishlistAsync(item.id));
    toast.success(`✓ ${item.title} eliminado de la lista de deseos`);
  };
